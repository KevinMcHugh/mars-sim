...
| [affect.md](./affect.md) | Charge/grip affect, event appraisal, trait transforms, decay, contextual labels, and focus contributions. |
| [mood-space.md](./mood-space.md) | **Proposal, partly implemented.** Supersedes parts of `affect.md`: a stored, event-driven valence axis, impact-weighted push/pull, habituation, and tag-based trait rules — plus the phased build plan and a tuning sandbox. |
